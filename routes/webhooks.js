...
router.get('/twitch/following', (req, res, next) => { // eslint-disable-line no-unused-vars
  debug('Confirmation of follow webhook subscription.');
  res.send(req.query['hub.challenge']);
});

router.post('/twitch/following', (req, res, next) => { // eslint-disable-line no-unused-vars
